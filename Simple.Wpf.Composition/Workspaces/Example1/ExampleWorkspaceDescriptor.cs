namespace Simple.Wpf.Composition.Workspaces.Example1
{
    ...
    {
        private readonly Uri _resources = new Uri("/simple.wpf.composition;component/workspaces/example1/resources.xaml", UriKind.RelativeOrAbsolute);
        ...
        public string Name { get { return "Example 1 Workspace"; } }
